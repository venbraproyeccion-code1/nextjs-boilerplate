export default function Terminos() {
  ...
  const s = [
    ...
    {t:"2. Descripción del Servicio",c:"VenBra Tech opera exclusivamente como plataforma de referidos y educación financiera. Referimos usuarios a plataformas de inversión reguladas de terceros (eToro, Arrived Homes, Fundrise). No somos asesores de inversión registrados, corredores de bolsa, ni planificadores financieros. No gestionamos fondos ni ejecutamos transacciones en nombre de los usuarios."},
    ...
    {t:"9. Ley Aplicable",c:"Estos términos se rigen por las leyes de la República Federativa de Brasil. Cualquier disputa estará sujeta a la jurisdicción de los tribunales de Santa Catarina, Brasil."},
    {t:"10. Contacto",c:"Para consultas sobre estos Términos de Servicio: alfonso@venbratech.com | venbratech.com"}
  ];
  return (
