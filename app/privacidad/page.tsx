export default function Privacidad() {
  ...
  const s = [
    ...
    {t:"4. Cookies y Tecnologías de Seguimiento",c:"Utilizamos cookies esenciales para el funcionamiento del sitio y cookies de análisis anónimas para mejorar la experiencia del usuario. No utilizamos cookies de publicidad comportamental de terceros. Al ingresar al sitio, un banner le permite aceptar o rechazar las cookies no esenciales antes de que se activen."},
    ...
    {t:"8. Servicios de Terceros",c:"Nuestro sitio incluye enlaces a plataformas de terceros (eToro, Arrived Homes, Fundrise, Nexo, TikTok). Estas plataformas tienen sus propias políticas de privacidad independientes. No somos responsables de sus prácticas de datos."},
    {t:"9. Base Legal y Cumplimiento Normativo",c:"Tratamos sus datos personales conforme a la Ley General de Protección de Datos de Brasil (LGPD, Ley 13.709/2018) y, cuando corresponda a usuarios de la Unión Europea, al Reglamento General de Protección de Datos (GDPR). Nuestra base legal para el tratamiento incluye su consentimiento (newsletter, cookies no esenciales) y la ejecución de un servicio solicitado (integración TikTok). Puede contactar a nuestro responsable de datos en alfonso@venbratech.com para cualquier solicitud amparada por estas normativas."},
    {t:"10. Cambios a esta Política",c:"Podemos actualizar esta política periódicamente. Los cambios se publicarán en esta página con la fecha de revisión. El uso continuado del servicio tras los cambios constituye su aceptación."},
    {t:"11. Contacto",c:"Para consultas sobre privacidad o para ejercer sus derechos: alfonso@venbratech.com | venbratech.com | Responsable: VenBra Tech, Santa Catarina, Brasil."}
  ];
  return (
